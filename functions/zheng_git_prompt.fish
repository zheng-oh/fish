...
set -g fish_prompt_git_status_normal '\xE2\x9C\x94 '
set -g fish_prompt_git_status_added  '\xE2\x9E\x95 '   #✚
set -g fish_prompt_git_status_modified '\xE2\x9C\xB4 '  #*
set -g fish_prompt_git_status_renamed '➜'
set -g fish_prompt_git_status_copied '⇒'
set -g fish_prompt_git_status_deleted '\xE2\x9C\x96 ' #✖
set -g fish_prompt_git_status_untracked '\xE2\x9D\x93 ' #?
set -g fish_prompt_git_status_unmerged '\xE2\x9D\x97 ' # !

set -g fish_prompt_git_status_order added modified renamed copied deleted untracked unmerged

function zheng_git_prompt --description 'Write out the git prompt'
    ...
    if test -z "$index"
        ...
        echo -n -e $secondary_color $branch$fish_prompt_git_status_normal
        return
    end
